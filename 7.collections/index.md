...
* [数组](7.1.array)：任意类型的泛型有序序列，提供一系列便利方法

* [紧缩数组](7.2.packed-array)：静态类型有序序列，大批量数据下拥有更佳的性能，支持的数据类型有限

* [字典](7.3.dictionary)：关联容器，使用键值对来对数据进行查询修改，字典所擅长的任务是数组所不擅长的，在插入/删除/移动方面最快
